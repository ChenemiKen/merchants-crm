...
import { booleanEnv, env, mandatoryEnv, mandatoryIntegerEnv } from '@/config/env'
...
const schema = env('DRIZZLE_SCHEMA', 'src/db/schemas');
const out = env('DRIZZLE_OUT', 'migrations');
